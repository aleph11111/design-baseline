...
- `src/components/ui/` (44 shadcn/ui primitives), `src/components/layout/` (AppShell/Sidebar/Header + shared chrome), `src/components/archetypes/` (one dir per shipped archetype; 15 registered in MANIFEST) — see `docs/ARCHITECTURE.md` for the full map.
