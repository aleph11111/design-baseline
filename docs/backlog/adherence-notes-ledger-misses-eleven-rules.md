...
[wip/adherence-shell-classname-rule-consolidation.md](wip/adherence-shell-classname-rule-consolidation.md)
...
- [wip/adherence-shell-classname-rule-consolidation.md](wip/adherence-shell-classname-rule-consolidation.md) — the filing this gap misled; it asked for the deletion of a ledger row that never existed.
