...
- [over-engineering-hand-rolled-glob-engine-duplicated.md](over-engineering-hand-rolled-glob-engine-duplicated.md) — the sibling stdlib swap in the same two files.
