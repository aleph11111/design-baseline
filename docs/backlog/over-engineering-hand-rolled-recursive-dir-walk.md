...
- [over-engineering-hand-rolled-glob-engine-duplicated.md](wip/over-engineering-hand-rolled-glob-engine-duplicated.md) — the sibling stdlib swap in the same two files.
